    ...
    public sealed class Data
    {
        ...
        public static DataSet FetchRS(CommandType cmdType, string cmdText, params SqlParameter[] cmdParams)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                conn.ConnectionString = Convert.ToString(objCommon._connectionStr);
    ...
    public sealed class Shared
    {
        ...
        public static string Read(string setting, string def)
        {
            try
            {
                ...
                return ToString(System.Configuration.ConfigurationManager.AppSettings["MobileProConnectionString"]);
            }
            catch
            {
                return def;
