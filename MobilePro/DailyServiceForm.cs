...
namespace MobilePro
{
    public class DailyServiceForm : IDisposable
    {
        ...
        {
            DataSet salesds = ReturnQueryService(servicedate, userid);
        ...
        public void Run()
        {
            try
            {
                ...
                report.ReportPath = @"DailyService.rdlc";
                ...
                ReportDataSource rptDS3 = new ReportDataSource("DataSet4", LoadServiceData());

                report.DataSources.Clear();
                report.DataSources.Add(rptDS);
                report.DataSources.Add(rptDS1);
                report.DataSources.Add(rptDS2);
                report.DataSources.Add(rptDS3);                
