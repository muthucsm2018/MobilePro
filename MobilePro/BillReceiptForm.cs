...
namespace MobilePro
{
    public class BillReceiptForm : IDisposable
    {
        ...
        private void Print()
        {
            ...
            printDoc.PrinterSettings.PrinterName = Shared.ToString(System.Configuration.ConfigurationManager.AppSettings["ServicePrinter"]);
        ...
        public void Run()
        {
            try
            {
                ...
                report.ReportPath = @"BillReceipt.rdlc";
